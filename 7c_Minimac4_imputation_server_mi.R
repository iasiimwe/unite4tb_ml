  ...
  for (mechanism in mechanisms) {
    for (missing_percentage in missing_percentages) {
      ...
      for (k in 1:n_datasets) {
        # Path
        vcf_file_path <- paste0("/pub59/iasiimwe/TB/datasets/michigan/",
                                mechanism, "_", missing_percentage,
                                "/chr", k, ".vcf.gz")
      ...
      write.csv(id_tb, paste0("/pub59/iasiimwe/TB/datasets/michigan/job_id_", 
                              mechanism, "_", missing_percentage, "_", 
                              ref_population, ".csv"), row.names = FALSE)
    }
  }
} 
